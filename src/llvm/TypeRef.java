...
public class TypeRef {
	...
	public static TypeRef FunctionType(
			...
			Pointer<? extends LLVMOpaqueType > ParamTypes,
	...
	public void    GetParamTypes(Pointer<Pointer<LLVMOpaqueType > > Dest) { LLVMGetParamTypes(type, Dest); }

	public static TypeRef StructTypeInContext(
			Context C,
			Pointer<Pointer<LLVMOpaqueType > > ElementTypes,
			int ElementCount,
			boolean Packed) { 
	...
	public void GetStructElementTypes(Pointer<Pointer<LLVMOpaqueType > > Dest) { LLVMGetStructElementTypes(type, Dest); }
